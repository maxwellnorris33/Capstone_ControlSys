...
%total lift force
if alpha <=0.1396
    CL = 0.5171 + 5.1289*alpha+0.3693046*u2+7.7844651*x5;
else
    CL = -325.7*alpha^3 + 187.55*alpha^2 - 33.32*alpha + 3.115;
end

%Total Drag Force (neglecting tail)
CD = 0.0338 + 0.0592*CL^2 + 0.2026740*x5 + 0.00227845*u2^2;

%Calculating Sideforce
CY = -0.3196103*(beta) - 0.1967684*u3 + 0.0291014*u1 + 0.0198380*x4 +0.1841734*x6;
