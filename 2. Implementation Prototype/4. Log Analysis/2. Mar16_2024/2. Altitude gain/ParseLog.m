...
%row number
lower_slice = 261837; %change this
upper_slice = 334457; %change this
slice_type = 'LineNo';
...
%getting real data
time_alt = sliced_log.GPS.TimeS-1476.37;
altitude = sliced_log.GPS.Alt-1196.71;
speed_time = sliced_log.ARSP.TimeS-1476.37;
