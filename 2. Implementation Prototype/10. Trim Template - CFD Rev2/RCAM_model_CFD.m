...
if u2 >=0
    MAcg_w = [(0.5630736*x4 + 0.1550179*x6 - 0.04469853078*beta + 0.4270157217*u1 + 0.04223666613*u3); %roll
        (-8.7067*x5 - 0.00875 - 0.00921*alpha - 1.085113628*u2); %pitch
        (-0.0595315*x6 - 0.0281*x4 + 0.1541638784*beta + 0.02641438212*u1 + 0.09215271354*u3)]*Q*S*cbar; %yaw
else
    MAcg_w = [(0.5630736*x4 + 0.1550179*x6 - 0.04469853078*beta + 0.4270157217*u1 + 0.04223666613*u3); %roll
        (-8.7067*x5 - 0.00875 - 0.00921*alpha - 1.134801189*u2); %pitch
        (-0.0595315*x6 - 0.0281*x4 + 0.1541638784*beta + 0.02641438212*u1 + 0.09215271354*u3)]*Q*S*cbar; %yaw
end
